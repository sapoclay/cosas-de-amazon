            ...
            const renderMultipleProductsGrid = () => {
                ...
                const renderSingleProductCard = (product, index) => {
                    ...
                    return el('div', {
                        ...
                        showSpecialOffer && (specialOfferText || product.discount || product.specialOffer) && el('div', {
                            className: 'cosas-amazon-special-offer'
                        }, el('span', {
                            style: {
                                backgroundColor: specialOfferColor
                            }
                        }, specialOfferText || (product.specialOffer ? product.specialOffer : (product.discount ? `Oferta ${product.discount}%` : 'Oferta')))),
                        ...
                        (showPrice || showDiscount) && el('div', { 
                            ...
                            showDiscount && product.discount && el('span', { 
                        ...
                        el('div', { 
                            ...
                            el('div', { className: 'cosas-amazon-carousel-container' },
                                ...
                                product.image && el('div', { className: 'cosas-amazon-carousel-item' },
                                    ...
                                    showDiscount && product.discount && el('span', { className: 'cosas-amazon-discount' }, `-${product.discount}%`),
                                    // Botón para carousel
                                    showButton && el('a', {
                                        href: amazonUrl,
                                        target: '_blank',
                            ...
                            el('table', { className: 'cosas-amazon-table', style: { width: '100%', borderCollapse: 'collapse' } },
                                ...
                                el('tbody', {},
                                    el('tr', {},
                                        ...
                                        el('td', { style: { border: '1px solid #ddd', padding: '8px' } }, 
                                            showDiscount && product.discount ? `-${product.discount}%` : 'N/A'
                                        ),
                                        el('td', { style: { border: '1px solid #ddd', padding: '8px' } }, 
                                            showButton && el('a', {
                                                href: amazonUrl,
                        ...
                        el('div', { 
                            ...
                            el('div', { style: { flex: 1 } },
                                ...
                                el('div', { style: { display: 'flex', alignItems: 'center', gap: '4px', marginTop: '2px' } },
                                    ...
                                    showSpecialOffer && (specialOfferText || product.discount || product.specialOffer) && el('span', { 
                                        style: { 
